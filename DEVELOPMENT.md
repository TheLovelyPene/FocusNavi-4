...
```bash
git remote add encore encore://focusnavi-app-ckc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/focusnavi-app-ckc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/focusnavi-app-ckc2/settings/integrations/github)
